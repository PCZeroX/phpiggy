...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  <form method="POST" class="grid grid-cols-1 gap-6">
    <?php include_once $csrfPartial;?>

    <!-- Email -->
    <label class="block">
      <span class="text-gray-700">Email address</span>
      <input value="<?php echo e($oldFormData['email'] ?? ''); ?>" name="email" type="email" autocomplete="email"
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        placeholder="zero@example.com" />
    ...
    <label class="block">
      ...
      <select name="country"
        ...
        <option value="Canada"
          <?php echo isset($oldFormData['country']) && $oldFormData['country'] === 'Canada' ? 'selected' : ''; ?>>
          Canada
        </option>
        <option value="Mexico"
          <?php echo isset($oldFormData['country']) && $oldFormData['country'] === 'Mexico' ? 'selected' : ''; ?>>
          Mexico
        </option>
    ...
    <label class="block">
      ...
      <input name="confirmPassword" type="password" autocomplete="current-password"
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        placeholder="" />
