...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  ...
  <form method="GET" class="mt-4 w-full">
    <div class="flex">
      <input value="<?php isset($searchTerm) && e((string) $searchTerm);?>" name="s" type="text"
  ...
  <!-- Transaction List -->
  <table class="table-auto min-w-full divide-y divide-gray-300 mt-6" aria-describedby="Transaction list">
  ...
  <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6"
    ...
    <div class="hidden md:-mt-px md:flex">
      ...
      <a href="/?<?php echo e($query); ?>" class="<?php echo $pageNum + 1 === $currentPage
